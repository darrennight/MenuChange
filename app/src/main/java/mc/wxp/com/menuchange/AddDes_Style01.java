 ...
 */
public class AddDes_Style01 extends View implements View.OnLongClickListener, View.OnClickListener {
    ...
    public AddDes_Style01(Context context) {
        super(context);
        init(context,null,0);
    }

    public AddDes_Style01(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context,attrs,0);
    }

    public AddDes_Style01(Context context, AttributeSet attrs, int defStyleAttr) {
